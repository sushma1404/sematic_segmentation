...
def test_for_kitti_dataset(data_dir):
   ...
   # assert training_labels_count == 289, 'Expected 289 training labels, found {} labels.'.format(training_labels_count)
    ...
    assert training_images_count == 386, 'Expected 289 training images, found {} images.'.format(training_images_count)
    assert training_labels_count == 386, 'Expected 289 training labels, found {} labels.'.format(training_labels_count)
    assert testing_images_count == 152, 'Expected 290 testing images, found {} images.'.format(testing_images_count)
